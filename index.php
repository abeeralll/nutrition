...
<body>
    <div class="container-fluid">
        ...
        <div class="body">
            <div class="header d-flex flex-column justify-content-center align-items-center mt-0">
                <span class="boxText">"Eat Well, Live Strong!"</span>
            </div>

            <div>
                <img src="image/nutritionist.jpg" class="image" width="600" height="400">
            </div>
                ...
                <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="col-md-6 d-flex flex-column p-0">
                            <img src="image/emma.jpg" class="image" height="500" width="300">
                        </div>
                        <div class="col ">
